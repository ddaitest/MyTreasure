...
public class HorizontalListView2 extends AdapterView<ListAdapter> {
	...
	private byte[] dataLock = new byte[0];
	...
	protected synchronized void onLayout(boolean changed, int left, int top,
		...
		Log.d("DDAO", "onLayout: changed=" + changed + ",left=" + left
		...
		Log.e("DDAI", "DX="+dx+"="+mCurrentX+"-"+mNextX);
	...
	private OnGestureListener mOnGesture = new GestureDetector.SimpleOnGestureListener() {
		...
		public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
				float velocityY) {
			return HorizontalListView2.this
			...
			for (int i = 0; i < getChildCount(); i++) {
				...
				if (isEventWithinView(e, child)) {
					...
					if (mOnItemSelected != null) {
						mOnItemSelected.onItemSelected(HorizontalListView2.this,
								child, mLeftViewIndex + 1 + i,
								mAdapter.getItemId(mLeftViewIndex + 1 + i));
					}
					break;
